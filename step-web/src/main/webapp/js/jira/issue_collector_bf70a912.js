...
//    }
            ...
            $(function() {
                try {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS
                            && ((window.ATL_JQ_PAGE_PROPS.triggerFunction) || (window.ATL_JQ_PAGE_PROPS["bf70a912"] && window.ATL_JQ_PAGE_PROPS["bf70a912"].triggerFunction))) {
                        newTriggerFunction = window.ATL_JQ_PAGE_PROPS.triggerFunction || window.ATL_JQ_PAGE_PROPS["bf70a912"].triggerFunction
                    } else {
    ...
    if ("bf70a912" !== "") {
        ATL_JQ(function() {
            var showTrigger = function(triggerConfig) {
                ...
                if (triggerConfig.recordWebInfo) {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS) {
                        ...
                        if (window.ATL_JQ_PAGE_PROPS.hasOwnProperty("bf70a912")) {
                            feedbackProps = window.ATL_JQ_PAGE_PROPS["bf70a912"];
            ...
            $.ajax({
                url : baseUrl + "/rest/collectors/1.0/configuration/trigger/bf70a912?os_authType=none",
                dataType : "jsonp",
                crossDomain : true,
                success : showTrigger
            })
