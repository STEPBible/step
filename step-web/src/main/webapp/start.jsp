                    ...
                    <span class="help">
                        <div class="headerButtons pull-right">
                            ...
                            <span class="navbar-collapse collapse">
                                <span class="dropdown">
                                    <a id="languages-icon" style="padding-top:44px;padding-left:5px" class="dropdown-toggle" data-toggle="dropdown" title="<fmt:message key="installation_book_language" />">
