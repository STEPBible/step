    ...
    showAbout: function () {
        $(_.template(
            '<div id="aboutModal" class="modal aboutModal" role="dialog" aria-labelledby="about" aria-hidden="true">' +
                ...
                'STEPBible is very grateful to many volunteers, publishers, Bible societies and others for their willingness to partner together in making trustworthy Bible study tools available to every person. <p />In particular, STEPBible would like to thank:' +
				'<ul>' +
