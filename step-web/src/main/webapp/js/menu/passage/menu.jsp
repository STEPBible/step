	...
	<ul>
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="javascript:void(0)" name="G" title="<fmt:message key="display_greek_accents_help" />" ><fmt:message key="display_greek_pointing" /></a></li>
                <li><a href="javascript:void(0)" name="U" title="<fmt:message key="display_hebrew_vowels_help" />" ><fmt:message key="display_hebrew_vowels" /></a></li>
                <li><a href="javascript:void(0)" name="P" title="<fmt:message key="display_pointing_include_hebrew_vowels_help" />" ><fmt:message key="display_pointing_include_hebrew" /></a></li>
            </ul>
        </li>
