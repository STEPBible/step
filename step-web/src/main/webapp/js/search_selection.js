...
step.searchSelect = {
	...
	_buildSearchHeaderAndTable: function() {
		...
		var html = '<div class="header">' +
			...
			'<textarea id="userTextInput" rows="1" class="stepFgBg" style="font-size:16px;width:80%" placeholder="Type here (use * for unended word or ? for missing letters)"></textarea><br><br>' + // size 16px so the mobile devices will not expand
			'<div id="search_table">' +
			'<table border="1">' +
			'<colgroup>' +
