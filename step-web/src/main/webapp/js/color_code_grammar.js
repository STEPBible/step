  ...
  addClassForTHOT: function(passageHTML, bibleVersions) {
    ...
    while (currentPos < pLength) {
      ...
      if (morphPos > -1) {
        ...
        else if ((bibleVersions.indexOf("ESV") > -1) || (bibleVersions.indexOf("NASB2020") > -1) || (bibleVersions.indexOf("NET2FULL") > -1) || (bibleVersions.indexOf("CUN") > -1) || (bibleVersions.indexOf("CUNS") > -1)) // ESV has not "TOS:" in morph code
          currentPos += 1;
        else
          continue;
