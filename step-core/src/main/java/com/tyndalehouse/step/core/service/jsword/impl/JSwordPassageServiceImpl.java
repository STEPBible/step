...
import static com.tyndalehouse.step.core.models.InterlinearMode.*;
        ...
        return (TransformingSAXEventProvider) new Converter() {
            ...
            public SAXEventProvider convert(final SAXEventProvider provider) throws TransformerException {
                try {
                    ...
                    else if (userLanguage.toLowerCase().startsWith("de")) changeVersion = "GerTafel";
                    else if (userLanguage.toLowerCase().startsWith("el")) changeVersion = "UMGreek";
                    else if (userLanguage.toLowerCase().startsWith("et")) changeVersion = "Est";
                    else if (userLanguage.toLowerCase().startsWith("fa")) changeVersion = "FCB";
                    else if (userLanguage.toLowerCase().startsWith("fil")) changeVersion = "TglASD";
                    else if (userLanguage.toLowerCase().startsWith("fi")) changeVersion = "FinPR";
                    else if (userLanguage.toLowerCase().startsWith("fr")) changeVersion = "FreSeg21";
                    else if (userLanguage.toLowerCase().startsWith("ga")) changeVersion = "IriODomhnuill";
                    else if (userLanguage.toLowerCase().startsWith("hr")) changeVersion = "HrvKOK";
                    else if (userLanguage.toLowerCase().startsWith("hu")) changeVersion = "HunKAR";
                    else if (userLanguage.toLowerCase().startsWith("id")) changeVersion = "IndFAYH";
                    else if (userLanguage.toLowerCase().startsWith("is")) changeVersion = "Icelandic";
                    else if (userLanguage.toLowerCase().startsWith("it")) changeVersion = "ItaRive";
                    else if (userLanguage.toLowerCase().startsWith("ja")) changeVersion = "JpnJCB";
                    else if (userLanguage.toLowerCase().startsWith("ko")) changeVersion = "KorKLB";
                    else if (userLanguage.toLowerCase().startsWith("lv")) changeVersion = "Latvian";
                    else if (userLanguage.toLowerCase().startsWith("ml")) changeVersion = "MalMCV";
                    else if (userLanguage.toLowerCase().startsWith("nl")) changeVersion = "NldHTB";
                    else if (userLanguage.toLowerCase().startsWith("pl")) changeVersion = "PolPSZ";
                    else if (userLanguage.toLowerCase().startsWith("pt")) changeVersion = "PorNVI";
                    else if (userLanguage.toLowerCase().startsWith("ro")) changeVersion = "RonNTR";
                    else if (userLanguage.toLowerCase().startsWith("ru")) changeVersion = "RusCARSA";
                    else if (userLanguage.toLowerCase().startsWith("sl")) changeVersion = "SlvZNZ";
                    else if (userLanguage.toLowerCase().startsWith("sq")) changeVersion = "Alb";
                    else if (userLanguage.toLowerCase().startsWith("sv")) changeVersion = "SweKarlXII1873";
                    else if (userLanguage.toLowerCase().startsWith("sw")) changeVersion = "Neno";
                    else if (userLanguage.toLowerCase().startsWith("th")) changeVersion = "ThaTNCV";
