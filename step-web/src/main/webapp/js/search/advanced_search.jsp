	...
	<fieldset name="SEARCH_PASSAGE">
		...
		<table class="passageTable">
			<tr>
				...
				<td class="noWrapCell"><input type="text" class="passageReference drop" size="15" /> <a href='javascript:void' class="searchPassageButtons searchPassage" type="button" title="<fmt:message key="search_search_button" />">&nbsp;</a></td>
			</tr>
			<tr level="1">
				...
				<td level="2"><input type="text" class="extraVersionsDisplayOptions drop" size="15" readonly=true"/> <a href='https://stepweb.atlassian.net/wiki/display/SUG/Bible+Displays' target="_new" class='interlinearHelp primaryDarkBold searchPassageButtons'>Interlinear help</a></td>
			</tr>
		</table>
	</fieldset>
