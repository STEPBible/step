...
public class SubjectEntryServiceImpl implements SubjectEntrySearchService {
     ...
     */
    @Inject
    public SubjectEntryServiceImpl(final EntityManager entityManager, final JSwordSearchService jswordSearch,
            final JSwordPassageService jsword, final JSwordVersificationService versificationService) {
        this.jsword = jsword;
