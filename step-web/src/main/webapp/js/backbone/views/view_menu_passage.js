var PassageMenuView = Backbone.View.extend({
    ...
    quickLexicon: '<li><a href="javascript:void(0)" data-selected="true"><span><%= __s.quick_lexicon %></span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isQuickLexicon ? "visible" : "hidden" %>"></span></a></li>',
    similarWord: '<li><a href="javascript:void(0)" data-selected="true"><span><%= __s.similar_word %></span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isSimilarWord ? "visible" : "hidden" %>"></span></a></li>',
    // enWithEsLexicon: '<li><a href="javascript:void(0)" data-selected="true"><span><%= __s.en_with_es_lexicon %></span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isEnWithEsLexicon ? "visible" : "hidden" %>"></span></a></li>',
    enWithZhLexicon: '<li><a href="javascript:void(0)" data-selected="true"><span><%= __s.en_with_zh_lexicon %></span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isEnWithZhLexicon ? "visible" : "hidden" %>"></span></a></li>',
    secondZhLexicon: '<li><a href="javascript:void(0)" data-selected="true"><span><%= __s.zh_second_zh_lexicon %></span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isSecondZhLexicon ? "visible" : "hidden" %>"></span></a></li>',
    verseVocab: '<li><a href="javascript:void(0)" data-selected="true"><span><%= __s.verse_vocab %></span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isVerseVocab ? "visible" : "hidden" %>"></span></a></li>',
    swipeLeftRight: '<li><a href="javascript:void(0)" data-selected="true"><span>Swipe left/right</span><span class="glyphicon glyphicon-ok pull-right" style="color: var(--clrText); background: var(--clrBackground); visibility: <%= isSwipeLeftRight ? "visible" : "hidden" %>"></span></a></li>',
    el: function () {
