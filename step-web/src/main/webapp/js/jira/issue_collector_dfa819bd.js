...
//    }
            ...
            $(function() {
                try {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS
                            && ((window.ATL_JQ_PAGE_PROPS.triggerFunction) || (window.ATL_JQ_PAGE_PROPS["dfa819bd"] && window.ATL_JQ_PAGE_PROPS["dfa819bd"].triggerFunction))) {
                        newTriggerFunction = window.ATL_JQ_PAGE_PROPS.triggerFunction || window.ATL_JQ_PAGE_PROPS["dfa819bd"].triggerFunction
                    } else {
    ...
    if ("dfa819bd" !== "") {
        ATL_JQ(function() {
            var showTrigger = function(triggerConfig) {
                ...
                if (triggerConfig.recordWebInfo) {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS) {
                        ...
                        if (window.ATL_JQ_PAGE_PROPS.hasOwnProperty("dfa819bd")) {
                            feedbackProps = window.ATL_JQ_PAGE_PROPS["dfa819bd"];
            ...
            $.ajax({
                url : baseUrl + "/rest/collectors/1.0/configuration/trigger/dfa819bd?os_authType=none",
                dataType : "jsonp",
                crossDomain : true,
                success : showTrigger
            })
