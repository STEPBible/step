    ...
    _renderToolbar: function () {
        ...
        $.each(definitions, function (i, item) {
            ...
            if (item.gloss) {
                ...
                else if ((step.userLanguageCode.toLowerCase() == "fr") && (item._fr_Gloss)) tmpGloss = item._fr_Gloss;
                else if ((step.userLanguageCode.toLowerCase() == "km") && (item._km_Gloss)) tmpGloss = item._km_Gloss;
