...
public class VocabularyServiceImplTest {
    ...
    public void testKeyExtraction() {
        final VocabularyServiceImpl vocab = new VocabularyServiceImpl(mock(EntityManagerImpl.class), mock(StrongAugmentationService.class), mock(JSwordSearchService.class));
