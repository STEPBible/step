        ...
        $.each(step.versions, function (index, item) {
            if (val) {
                ...
                if (item.shortInitials.match(regex) != null ||
                    ...
                    (step.version &&
                        step.version.names[item.initials.toLowerCase()] &&
                        step.version.names[item.initials.toLowerCase()].name &&
                        step.version.names[item.initials.toLowerCase()].name.match(regex))
                    ) {
