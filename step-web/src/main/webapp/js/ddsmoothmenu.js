...
//    ignoreHoverDDSmoothMenu: 0,
    ...
    css3support : window.msPerformance || (!document.all && document.querySelector), // detect
                                                                                        // browsers
                                                                                        // that
                                                                                        // support
                                                                                        // CSS3
...
//            }
        ...
        $headers.each(function(i) { // loop through each LI header
            ...
            this.istopheader = $curobj.parents("ul").length == 1 ? true : false; // is
                                                                                    // top
                                                                                    // level
                                                                                    // header?
            $subul.css({
            ...
            if (smoothmenu.shadow.enable && !smoothmenu.css3support) { // if
                ...
                }); // insert shadow DIV and set it to parent node for the next
                    // shadow div
            }
...
//                }
                ...
                $targetul.data('timers').showtimer = setTimeout(function() {
                    ...
                    menuleft = (header._offsets.left + menuleft + header._dimensions.subulw > $(window).width()) ? (header.istopheader
                            && setting.orientation != 'v' ? -header._dimensions.subulw + header._dimensions.w : -header._dimensions.w) : menuleft; // calculate
                                                                                                                                                    // this
                                                                                                                                                    // sub
                                                                                                                                                    // menu's
                                                                                                                                                    // offsets
                    ...
                    if ($targetul.queue().length <= 1) { // if 1 or less
                        ...
                        if (smoothmenu.shadow.enable && !smoothmenu.css3support) {
                            ...
                            if (!header.istopheader && ddsmoothmenu.detectwebkit) { // in
                                                                                    // WebKit
                                                                                    // browsers,
                                                                                    // restore
                                                                                    // shadow's
        ...
        if (smoothmenu.shadow.enable && smoothmenu.css3support) { // if
            ...
            var css3shadow = parseInt(smoothmenu.shadow.offsetx) + "px " + parseInt(smoothmenu.shadow.offsety) + "px 5px #aaa"; // construct
                                                                                                                                // CSS3
                                                                                                                                // box-shadow
                                                                                                                                // value
            var shadowprop = [ "boxShadow", "MozBoxShadow", "WebkitBoxShadow", "MsBoxShadow" ]; // possible
                                                                                                // vendor
                                                                                                // specific
                                                                                                // CSS3
                                                                                                // shadow
    ...
    init : function(setting) {
        if (typeof setting.customtheme == "object" && setting.customtheme.length == 2) { // override
                                                                                            // default
                                                                                            // menu
                                                                                            // colors
                                                                                            // (default/hover)
        ...
        this.shadow.enable = (document.all && !window.XMLHttpRequest) ? false : this.shadow.enable; // in
                                                                                                    // IE6,
                                                                                                    // always
                                                                                                    // disable
                                                                                                    // shadow
