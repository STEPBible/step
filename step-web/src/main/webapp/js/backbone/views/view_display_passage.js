var PassageDisplayView = DisplayView.extend({
        ...
        render: function () {
            ...
            if (((bibleVersions.indexOf('ESV') > -1) || (bibleVersions.indexOf('THOT') > -1) || (bibleVersions.indexOf('OHB') > -1) || (bibleVersions.indexOf('NASB2020') > -1) || (bibleVersions.indexOf("CHIUN1") > -1) || (bibleVersions.indexOf('_MORPH') > -1)) &&
            ...
            if (((bibleVersions.indexOf('ESV') > -1) || (bibleVersions.indexOf('KJV') > -1) ||
                (bibleVersions.indexOf('SBLG') > -1) || (bibleVersions.indexOf('THGNT') > -1) || (bibleVersions.indexOf('CUN') > -1) || (bibleVersions.indexOf('NASB2020') > -1) || (bibleVersions.indexOf("CHIUN1") > -1) || (bibleVersions.indexOf('_MORPH') > -1)) &&
