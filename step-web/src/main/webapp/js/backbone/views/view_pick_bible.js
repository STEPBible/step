var PickBibleView = Backbone.View.extend({
    ...
    modalPopupTemplate: _.template('<div class="modal selectModal" id="bibleVersions" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">' +
		...
		((step.touchDevice) ? "" : '<textarea id="enterYourTranslation" rows="1" style="font-size:13px;width:95%" placeholder="<%= __s.pick_bible_input_placeholder %>"></textarea><br><br>') +
        ...
        '<div class="modal-footer">' +
			((step.touchDevice) ? '<textarea id="enterYourTranslation" rows="1" style="font-size:16px;width:90%" placeholder="<%= __s.pick_bible_input_short_placeholder %>"></textarea>' : "") +
