...
<div class="advancedSearch" style="clear: both">
	...
	<fieldset>
		...
		<span class="passageButtons">  
			...
			<a class="nextChapter" href="?reference=<%= stepRequest.getPreviousReference(0) %>&version=<%= stepRequest.getVersion(Integer.parseInt(request.getParameter("passageId"))) %>">Displays the next chapter (or expands to the end of the chapter)</a> <a
