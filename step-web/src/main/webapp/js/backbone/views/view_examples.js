					...
					'<ul style="padding-inline-start:10px">' +
						...
						'<li style="font-weight:bold"><span id="g4q6">How do I display the color-coded grammar?</span><a id="color-qa" style="margin-bottom:6px;font-size:14px" class="glyphicon glyphicon-triangle-right stepExample"></a></li>' +
							'<div class="stepExample" style="display:none">' +
								...
								'<br><span id="g4q6a3">3) Click on the Option button, then click "Interlinear options", then click “Color code grammar”. The text will then be color coded.</span>' +
								...
								'<br><span id="g4q6a4">4) To understand the color code, click on the button “Configure color code grammar”.</span>' +
